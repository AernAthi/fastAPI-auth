...
def login(payload: schemas.LoginUserSchema, response: Response, db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    ...
    response.set_cookie('access_token', access_token, ACCESS_TOKEN_EXPIRES_IN * 300,
                        ACCESS_TOKEN_EXPIRES_IN * 300, '/', None, False, True, 'lax')
    response.set_cookie('refresh_token', refresh_token,
                        REFRESH_TOKEN_EXPIRES_IN * 300, REFRESH_TOKEN_EXPIRES_IN * 300, '/', None, False, True, 'lax')
    response.set_cookie('logged_in', 'True', ACCESS_TOKEN_EXPIRES_IN * 300,
                        ACCESS_TOKEN_EXPIRES_IN * 300, '/', None, False, False, 'lax')
